...
「予測結果（{prediction_horizon}点）:」に続けてカンマ区切りの数値列のみを
{prediction_horizon}個出力してください。"""
...
for split in ["train", "val"]:
    ...
    output_path = Path(f"data/ett_256_format_focused/{split}.json")
